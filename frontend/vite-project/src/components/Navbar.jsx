...
const Navbar = () => {
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-8 fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="navbar">
        <div className="navbar-start">
          ...
          <div className="dropdown">
            ...
            <ul className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-white text-black rounded-box w-52">
              {navItems}
            </ul>
          </div>
          <a className="text-2xl font-bold text-black">BookStore</a>
        </div>
